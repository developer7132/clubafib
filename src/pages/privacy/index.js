...
class Privacy extends React.Component {
  constructor(props) {
    ...
    for (let i = 0; i < 16; i++) {
      ...
      this.boxRefs.push(ref);
    }
  }

  moveToContent = (index) => {
    window.scrollTo(0, this.boxRefs[index].current.offsetTop - 100)
  }
  ...
  render() {
    return (
      <div className="showdow-box">
        <Helmet 
            title="Privacy Policy | Club Afib"
            meta={[
              { name: 'description', content: 'Thank you for choosing to be part of our community at Club Afib Inc ("Company", "we", "us", "our"). We are committed to protecting your personal information and your right to privacy. If you have any questions or concerns about this privacy notice, or our practices with regards to your personal information, please contact us at support@clubafib.com.' },
              { name: 'keywords', content: 'club, afib, privacy, policy' }
            ]}
            link={[{rel: 'canonical', href: 'https://clubafib.com/privacy-policy'}]}
          />
       <h4> Club AFIB. LLC PRIVACY POLICY </h4>
       <p>Last updated September 13, 2020</p>
       <p>Thank you for choosing to be part of our community at Club Afib Inc ("Company", "we", "us", "our"). We are committed to protecting your personal information and your right to privacy. If you have any questions or concerns about this privacy notice, or our practices with regards to your personal information, please contact us at support@clubafib.com.</p>
       ...
       <p>Please read this privacy notice carefully as it will help you understand what we do with the information that we collect.</p><br/>

       <h4>TABLE OF CONTENTS</h4>
       {Titles.map((item, index) => <p key={index} style={{cursor: 'pointer'}} onClick={e => this.moveToContent(index)}>
         <b>{item}</b>
       </p>)}
       <br/>

       <h4 ref={this.boxRefs[0]}>1. WHAT INFORMATION DO WE COLLECT?</h4><br />
       ...
       <p>• <i>Log and Usage Data.</i> Log and usage data is service-related, diagnostic, usage and performance information our servers automatically collect when you access or use our Services and which we record in log files. Depending on how you interact with us, this log data may include your IP address, device information, browser type and settings and information about your activity in the Services (such as the date/time stamps associated with your usage, pages and files viewed, searches and other actions you take such as which features you use), device event information (such as system activity, error reports (sometimes called 'crash dumps') and hardware settings).</p>
       <p><b>Information collected through our App</b></p>
       <p><i>In Short:  We collect information regarding your geo-location, mobile device, push notifications, when you use our App.</i></p>
       <p>If you use our App, we also collect the following information:</p>
       <p>• <i>Geo-Location Information.</i> We may request access or permission to and track location-based information from your mobile device, either continuously or while you are using our App, to provide certain location-based services. If you wish to change our access or permissions, you may do so in your device's settings.</p>
       <p>• <i>Mobile Device Access.</i> We may request access or permission to certain features from your mobile device, including your mobile device's bluetooth, camera, reminders, sensors, sms messages, social media accounts, storage, wearable data, calendar, and other features. If you wish to change our access or permissions, you may do so in your device's settings.</p>
       <p>• <i>Push Notifications</i> We may request to send you push notifications regarding your account or certain features of the App. If you wish to opt-out from receiving these types of communications, you may turn them off in your device's settings.</p>
       ...
       <h4 ref={this.boxRefs[1]}>2. HOW DO WE USE YOUR INFORMATION?</h4>
       <p><i>In Short:  We process your information for purposes based on legitimate business interests, the fulfillment of our contract with you, compliance with our legal obligations, and/or your consent.</i></p>
       ...
       <p>• To send you marketing and promotional communications. We and/or our third-party marketing partners may use the personal information you send to us for our marketing purposes, if this is in accordance with your marketing preferences. For example, when expressing an interest in obtaining information about us or our Services, subscribing to marketing or otherwise contacting us, we will collect personal information from you. You can opt-out of our marketing emails at any time (see the <u>"WHAT ARE YOUR PRIVACY RIGHTS"</u> below).</p>
       <p>• Deliver targeted advertising to you. We may use your information to develop and display personalized content and advertising (and work with third parties who do so) tailored to your interests and/or location and to measure its effectiveness.</p>
        ...
        <h4 ref={this.boxRefs[2]}>3. WILL YOUR INFORMATION BE SHARED WITH ANYONE?</h4>
        <p><i>In Short:  We only share information with your consent, to comply with laws, to provide you with services, to protect your rights, or to fulfill business obligations.</i></p>
        ...
        <h4 ref={this.boxRefs[3]}>4. THIRD PARTIES</h4>
        ...
        <h4 ref={this.boxRefs[4]}>5. DO WE USE GOOGLE MAPS?</h4>
        <p><i>In Short:  Yes, we use Google Maps for the purpose of providing better service.</i></p>
        <p>This Website or App uses Google Maps APIs which is subject to Google’s Terms of Service. You may find the Google Maps APIs Terms of Service <a href="https://developers.google.com/maps/terms">here.</a> To find out more about Google’s Privacy Policy, please refer to this <a href="https://policies.google.com/privacy">link.</a></p>
        <p>We use the Google Maps API to retrieve certain information when you make location-specific requests. This includes:</p>
        <p>For a full list of what we use information for, please see the previous section titled <u>"HOW DO WE USE YOUR INFORMATION?"</u> and <u>"WILL YOUR INFORMATION BE SHARED WITH ANYONE?".</u></p>
        <p>The Maps APIs that we use store and access cookies and other information on your devices. If you are a user currently in the European Economic Area (EU countries, Iceland, Liechtenstein and Norway), please take a look at our Cookie Notice.</p>
        
        <h4 ref={this.boxRefs[5]}>6. HOW DO WE HANDLE YOUR SOCIAL LOGINS?</h4>
        <p><i>In Short:  If you choose to register or log in to our services using a social media account, we may have access to certain information about you.</i></p>
        ...
        <h4 ref={this.boxRefs[6]}>7. IS YOUR INFORMATION TRANSFERRED INTERNATIONALLY?</h4>
        <p><i>In Short:  We may transfer, store, and process your information in countries other than your own.</i></p>
        <p>Our servers are located in. If you are accessing our Services from outside, please be aware that your information may be transferred to, stored, and processed by us in our facilities and by those third parties with whom we may share your personal information (see <u>"WILL YOUR INFORMATION BE SHARED WITH ANYONE?"</u> above), in and other countries.</p>
        ...
        <h4 ref={this.boxRefs[7]}>8. HOW LONG DO WE KEEP YOUR INFORMATION?</h4>
        ...
        <h4 ref={this.boxRefs[8]}>9. HOW DO WE KEEP YOUR INFORMATION SAFE?</h4>
        <p><i>In Short:  We aim to protect your personal information through a system of organizational and technical security measures.</i></p>
        ...
        <p>If you have questions or comments about your privacy rights, you may email us at support@clubafib.com.</p>
        ...
        <h4 ref={this.boxRefs[11]}>12. CONTROLS FOR DO-NOT-TRACK FEATURES</h4>
        ...
        <h4 ref={this.boxRefs[12]}>13. DO CALIFORNIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</h4>
        <p><i>In Short:  Yes, if you are a resident of California, you are granted specific rights regarding access to your personal information.</i></p>
        ...
        <h4 ref={this.boxRefs[13]}>14. DO WE MAKE UPDATES TO THIS NOTICE?</h4>
        ...
        <h4 ref={this.boxRefs[14]}>15. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</h4>
        <p>If you have questions or comments about this notice, you may email us at support@clubafib.com</p>

        <h4 ref={this.boxRefs[15]}>16. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?     </h4>
        <p>Based on the applicable laws of your country, you may have the right to request access to the personal information we collect from you, change that information, or delete it in some circumstances. To request to review, update, or delete your personal information, please submit a request form by clicking <a href="https://app.termly.io/notify/5a18416b-b569-44fe-a787-15ebf00626d3">here.</a> We will respond to your request within 30 days.</p>
        <p>This privacy policy was created using <a href="https://termly.io/products/privacy-policy-generator/?ftseo">Termly’s Privacy Policy Generator.</a></p>
      </div>
    )
  }
}
