        ...
        <Row className="justify-content-center">
          <Col md="6">
            <div className="v-r">
              ...
              <p style={{fontSize:"1.2em",textAlign:"center",fontWeight:"700",marginTop:"10px"}}>MARIA RUMSEY, MD</p>
              <p>
          ...
          <Col md="6">
            <div className="v-r">
              ...
              <p style={{fontSize:"1.2em",textAlign:"center",fontWeight:"700",marginTop:"10px"}}>NITESH SOOD, MD</p>
              <p>
