  ...
  render() {
    return (
      <div className="showdow-box">
        ...
        />
        <h4 style={{textAlign:"center"}}>Club Afib Terms of Service</h4>
        <br></br>
        ...
        <h5>Collection and Use of Identifiable Information</h5>
        <p>
        ...
        <h5>Electronic Communications Terms</h5>
        ...
        <h5>Risks and Your Responsibility</h5>
        <p>
        ...
        <h5>Conditions for Communicating Electronically with Club Afib</h5>
        ...
        <h5>Dispute Resolution and Arbitration</h5>
        <p>
        ...
        <h5>Club Afib Contact Information</h5>
